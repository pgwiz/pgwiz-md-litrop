...
async function reactToStatus(sock, statusKey) {
    try {
        ...
        // Multi-Device Status Reaction Relay Stanza (Fresh unique messageId generated by Baileys)
        ...
        console.log(`[AUTOSTATUS] ✅ Reacted to status ${statusKey.id} from ${participant} with ${emoji}`);
    } catch (error) {
