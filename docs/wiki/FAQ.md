...
**Answer**: Make sure your phone number (including country code without + sign) is entered in `OWNER_NUMBER=254111791418` in your `.env` file.

### Q3: How do I ignore specific contacts from Auto Status?
**Answer**: Use the command:
```text
.autostatus ignore 254712345678
.autostatus unignore 254712345678
.autostatus ignored
```
